...
const ExperiencesListPage = ( {starturl, userPos, baseurl} ) => {
    ...
    useEffect(() => {
        ...
        setCards(filteredExperiences.map((experience) => <ExperienceCard key={experience.linkTitle} starturl={starturl} baseurl={baseurl} experience={experience} />));
        ...
        <div className="section section--experiencesoverview">
            <div className="section_content">
                ...
                <div className="location_experiences">
                    ...
                    <ExperienceCardList starturl={starturl} experienceCards={cards} filterSettings={filterSettings} locationID={locationdata.ID} userPos={userPos} baseurl={baseurl}/>
                </div>
            </div>
        </div>
    )
